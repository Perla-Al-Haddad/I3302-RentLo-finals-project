...
namespace I3302_RentLo_finals_project.Migrations
{
    ...
    [Migration("20220711135637_FixUserIdFKUserPropertyRent")]
    partial class FixUserIdFKUserPropertyRent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("I3302_RentLo_finals_project.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("I3302_RentLo_finals_project.Models.City", b =>
                {
                    b.HasOne("I3302_RentLo_finals_project.Models.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("I3302_RentLo_finals_project.Models.Property", b =>
                {
                    b.HasOne("I3302_RentLo_finals_project.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("I3302_RentLo_finals_project.Models.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("I3302_RentLo_finals_project.Models.ApplicationUser", "Creator")
                        .WithMany("properties")
            ...
            modelBuilder.Entity("I3302_RentLo_finals_project.Models.UserPropertyRent", b =>
                {
                    ...
                    b.HasOne("I3302_RentLo_finals_project.Models.ApplicationUser", "Renter")
                        .WithMany()
